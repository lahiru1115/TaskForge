...
### Phase 4 — Remaining
- [ ] Undo via toast: 5-second undo after delete/status drag using soft-delete (`deletedAt`)
- [ ] Trash page (`/trash`): admin/creator can restore or permanently delete soft-deleted tasks
